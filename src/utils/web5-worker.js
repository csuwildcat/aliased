/*
  ...
  Be mindful that code placed in any open execution space may be evaluated multiple times in different contexts,
...
// Not sure if this is working as expected in all environments, created an issue
...
async function resetContextMenuTarget(e) {
  if (e?.type === "pointerup") {
